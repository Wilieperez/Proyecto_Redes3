...
comands = [
    [ #Configuraciones Router 5
    "ip route 10.0.10.0 255.255.255.0 10.0.0.18",
    "router ospf 10",
    ...
    # "no ip route 0.0.0.0 0.0.0.0 se 0/0/0"
    ],

    [ #Configuraciones Router Profe
    "int fa 0/1.10",
    ...
    #"no ip route 0.0.0.0 0.0.0.0 fa 0/0"
    ],

    [ #Configuraciones Router 6
    "router ospf 10",
    "network 10.0.0.4 0.0.0.3 area 1",
    "network 10.0.0.12 0.0.0.3 area 1",
    "network 10.0.30.0 0.0.0.255 area 1",
